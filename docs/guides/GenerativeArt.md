...
*  Have used the [`graphics`](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/) module of `ggez` to draw shapes
...
## [ggez::graphics](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/)

Glancing over the docs for [`ggez::graphics`](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/) you can see there is a lot of functionality there.
The basic shapes can be found in [`graphics::Mesh`](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#methods)

So which shapes are in `Mesh`?

* [line](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_line)
* [circle](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_circle)
* [ellipse](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_ellipse)
* [polygon](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_polygon)
* [polyline](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_polyline)
* [rectangle](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_rectangle)
* [rounded rectangle](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_rounded_rectangle)
...
* [from_frame](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Canvas.html#method.from_frame)
* [draw](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Canvas.html#method.draw)
* [finish](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Canvas.html#method.finish)
...
Here is the code for a [circle](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_circle):
...
[`graphics::DrawMode::fill()`](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/enum.DrawMode.html) is choosing between
...
Here is the code for a [rectangle](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Mesh.html#method.new_rectangle):
```rust,skt-expression,no_run
...
[`Rect`](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Rect.html) is a convenient type that represents a... rectangle!
[`graphics::Rect::new(500.0, 250.0, 200.0, 100.0)`](https://docs.rs/ggez/0.10.0-rc0/ggez/graphics/struct.Rect.html) positions the rectangle's top-left corner at `x: 500, y: 250` and
